...
public class MasterServlet extends HttpServlet implements EnvSet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "tomaster":
			//フォワードを実行
			RequestDispatcher dispatcherLogin1 = request.getRequestDispatcher("/WEB-INF/jsp/master.jsp");
...
//			//フォワードを実行
//			RequestDispatcher dispatcherLogin5 = request.getRequestDispatcher("/WEB-INF/jsp/rentnow.jsp");
