<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%-- <%@ page import="dto.ForListDTO,java.util.List,java.util.ArrayList" %>
	<% List<ForListDTO>list=(List<ForListDTO>)session.getAttribute("rentNowList"); %>
	<% %> --%>
